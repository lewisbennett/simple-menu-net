...
namespace SimpleMenu.Core.ViewModels.List
{
    public class IngredientsListViewModel : RefreshableListBaseViewModel<IngredientModel>
    {
        ...
        public override async Task LoadInitialPageAsync()
        {
            ...
            InvokeOnMainThread(() => UpdateCollection(CoreServiceWrapper.ActiveUser.Ingredients));
        }
        ...
        {
            NavigationService.Navigate<CreateIngredientViewModel>();
        }
        #endregion
        ...
        public override void ViewCreated()
        {
            ...
            UpdateCollection(CoreServiceWrapper.ActiveUser.Ingredients);
        }
        #endregion
